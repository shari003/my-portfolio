                ...
                <div className='flex flex-col'>
                    ...
                    >
                        ...
                        <div className='col-span-4 flex flex-col gap-6 2xl:text-2xl'>
                            ...
                            <p className={`text-sm 2xl:text-xl uppercase`}>Currently working with <br className='md:hidden block' /><a href={`https://www.tutort.net?utm_source=shri+hari+portfolio&utm_medium=shri.is-a.dev`} target='_blank' className='underline underline-offset-2 font-semibold'>Tutort Academy LLP</a> as a Software Engineer II</p>
                        </div>
                    </motion.div>
                </div>
            </div>
