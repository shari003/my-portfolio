...
export default function About() {
    return (
        <section className='min-h-screen bg-black text-white' id='about'>
            <div className='pt-24 min-h-full max-w-7xl mx-auto px-12'>
                <div className='flex flex-col'>
                    ...
                    <motion.div 
                        className='-mt-20 grid grid-cols-6'
                        initial={{ opacity: 0, y: 100 }}
                        whileInView={{ opacity: 1, y: 0 }}
                        transition={{ duration: 0.5, ease: "easeOut" }}
                        viewport={{ once: false }}
                    >
                        <div className={`col-span-2 ${rubikGlitch.className}`}>
                        ...
                        <div className='col-span-4 flex flex-col gap-6'>
                            ...
                            <p className={`text-sm uppercase`}>Currently working with <Link href={"https://www.tutort.net?utm_source=shri+hari&utm_medium=shrihari.dev"} target='_blank' className='underline underline-offset-2 font-semibold'>Tutort Academy LLP</Link> as a Software Developer</p>
                        </div>
                    </motion.div>
                </div>
            </div>
